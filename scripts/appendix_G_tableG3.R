...
# Coan, Holman (2023) -- Appendix Table G.3: Campaign Accounts
...
# Load data
data <- read.csv("data/data_campaign.csv")
...
write.csv(estimates_labels, "tables/appendix_G_tableG3.csv", row.names = FALSE)
